...
<head>
    ...
    <title>Đặt Lại Mật Khẩu - TyuuMei</title>
        ...
        <section class="container mx-auto px-6 py-12">
            ...
            <div class="bg-white p-8 sm:p-10 shadow-md rounded-xl max-w-md mx-auto">
                ...
                <form action="{{ route('password.update') }}" method="POST" class="space-y-6">
                    ...
                    <div>
                        <label for="password_confirmation" class="block text-gray-700 font-medium mb-1">Xác nhận mật khẩu
                            mới</label>
                    ...
                    <button type="submit"
                        ...
                        <i class="fas fa-lock-open mr-2"></i> Đặt lại mật khẩu
                    </button>
                </form>
