    ...
    <div class="content-wrapper">
        ...
        <div class="border border-blue-100 mb-3 rounded-lg p-2">
            <div class="flex items-center justify-between">
                <h2 class="text-xl font-bold text-blue-600">SỬA BANNER</h2>
                ...
                <div class="grid grid-cols-3 gap-6">
                    ...
                    <div class="col-span-2">
                        ...
                        <div class="mb-3">
                            ...
                            <input value="{{ old('name', $banner->name) }}" type="text" name="name" id="name"
                                placeholder="Nhập tên banner" class="w-full border border-gray-300 rounded-lg p-2">
                            @if ($errors->has('name'))
                        ...
                        {{-- <div class="mb-3">
                            ...
                            <input value="{{ old('link', $banner->link) }}" type="text" name="link" id="link" placeholder="https://..."
                        ...
                        <div class="mb-3">
                            ...
                            <textarea name="description" id="description" rows="4" class="w-full border  border-gray-300  rounded-lg p-2">{{ old('description', $banner->description) }}</textarea>
                    ...
                    <div class="col-span-1">
                        ...
                        <div class="mb-3">
                            ...
                            <!-- Input file để người dùng tải lên ảnh mới -->
                            ...
                            @if ($banner->image)
                                <div class="mb-2">
                                    <img src="{{ asset('assets/images/banner/' . $banner->image) }}" alt="Ảnh hiện tại"
                                        class="w-24 rounded">
                                </div>
                            @endif
                        ...
                        <div class="mb-3">
                            ...
                            <select name="status" id="status" class="w-full border border-gray-300 rounded-lg p-2">
                                <option value="1" {{ old('status', $banner->status) == 1 ? 'selected' : '' }}>Hiển
                                    thị</option>
                                <option value="0" {{ old('status', $banner->status) == 0 ? 'selected' : '' }}>Ẩn
                                </option>
                            </select>
