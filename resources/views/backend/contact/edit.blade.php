    ...
    <div class="content-wrapper">
        ...
        <div class="border border-blue-100 mb-3 rounded-lg p-2">
            <div class="flex items-center justify-between">
                <h2 class="text-xl font-bold text-blue-600">CẬP NHẬT LIÊN HỆ</h2>
                    ...
                    <div class="col-span-2">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea name="content" id="content" rows="4"
                                      class="w-full border border-gray-300 rounded-lg p-2">{{ old('content', $contact->content) }}</textarea>
                            @error('content')
                                <div class="text-red-500 text-sm mt-1">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="col-span-1">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea name="title" id="title" rows="4"
                                      class="w-full border border-gray-300 rounded-lg p-2">{{ old('title', $contact->title) }}</textarea>
                            @error('title')
                                <div class="text-red-500 text-sm mt-1">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <select name="status" id="status" class="w-full border border-gray-300 rounded-lg p-2">
                                ...
                                <option value="0" {{ old('status', $contact->status) == 0 ? 'selected' : '' }}>Không xuất bản</option>
                            </select>
                        </div>
                    </div>
                </div>
