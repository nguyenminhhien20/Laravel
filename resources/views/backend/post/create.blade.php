            ...
            <form action="{{ route('post.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="grid grid-cols-3 gap-6">
                    ...
                    <div class="col-span-2">
                        ...
                        <div class="mb-3">
                            ...
                            <input value="{{ old('title') }}" type="text" name="title" id="title" placeholder="Nhập tiêu đề"
                        ...
                        <div class="mb-3">
                            ...
                            <textarea name="detail" id="detail" class="w-full border border-gray-300 rounded-lg p-2 focus:outline-none focus:ring-2 focus:ring-blue-400" required>{{ old('detail') }}</textarea>
                    ...
                    <div class="col-span-1">
                        ...
                        <div class="mb-3">
                            ...
                            <select name="topic_id" id="topic_id" class="w-full border border-gray-300 rounded-lg p-2 focus:outline-none focus:ring-2 focus:ring-blue-400" required>
                        ...
                        <div class="mb-3">
                            ...
                            <select name="status" id="status" class="w-full border border-gray-300 rounded-lg p-2 focus:outline-none focus:ring-2 focus:ring-blue-400">
                ...
                <div class="text-center mt-4">
                    <button type="submit" class="bg-rose-500 text-white px-4 py-2 rounded-md">
                        <i class="fa fa-save mr-1"></i> Lưu bài viết
                    </button>
                </div>
            </form>
        </div>
