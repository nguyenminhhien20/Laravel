    ...
    <div class="content-wrapper">
        ...
        <div class="bg-white border border-blue-200 rounded-xl shadow px-6 py-4 mb-6">
            <div class="flex items-center justify-between">
                <h2 class="text-2xl font-bold text-blue-600">🗑️ Thùng Rác Sản Phẩm</h2>
            ...
            <table class="min-w-full divide-y divide-gray-200">
                <thead class="bg-blue-100">
                    <tr>
                        ...
                        <th class="px-4 py-3 text-left text-sm font-semibold text-gray-700">Tên Sản Phẩm</th>
                        <th class="px-4 py-3 text-left text-sm font-semibold text-gray-700">Danh Mục</th>
                        <th class="px-4 py-3 text-left text-sm font-semibold text-gray-700">Thương Hiệu</th>
                ...
                <tbody class="bg-white divide-y divide-gray-100">
                    @foreach ($list as $item)
                        <tr class="hover:bg-gray-50 transition">
                            ...
                            <td class="px-4 py-3 text-sm text-gray-800">{{ $item->categoryname }}</td>
                            <td class="px-4 py-3 text-sm text-gray-800">{{ $item->brandname }}</td>
